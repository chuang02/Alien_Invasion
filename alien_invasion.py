...
class AlienInvasion:
    ...
    def _check_events(self):
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                sys.exit()
            elif event.type == pygame.KEYDOWN: # When the key is pressed down
    ...
    def _check_keydown_events(self, event):
        ...
        if event.key == pygame.K_RIGHT: # When the right arrow is pressed
            self.ship.moving_right = True
        elif event.key == pygame.K_LEFT: # When the left arrow is pressed
